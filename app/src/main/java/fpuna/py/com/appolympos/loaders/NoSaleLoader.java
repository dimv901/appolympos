...
public class NoSaleLoader extends AsyncTaskLoader<List<Transactions>> {

    private NoSaleObserver mObserver;
    private List<Transactions> mData;

    public NoSaleLoader(Context context) {
        super(context);
    }
    ...
    public List<Transactions> loadInBackground() {
        ...
        qb.where(TransactionsDao.Properties.Type.eq(Constants.NO_SALE_TRANSACTION));
    ...
    protected void onStartLoading() {
        ...
        if (mObserver == null) {
            mObserver = new NoSaleObserver(this);
        }
